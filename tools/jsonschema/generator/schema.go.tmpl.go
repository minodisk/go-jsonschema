...
func schemaGoTmpl() (*asset, error) {
	bytes, err := schemaGoTmplBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "schema.go.tmpl", size: 551, mode: os.FileMode(420), modTime: time.Unix(1438307529, 0)}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"schema.go.tmpl": &bintree{schemaGoTmpl, map[string]*bintree{
	}},
}}
